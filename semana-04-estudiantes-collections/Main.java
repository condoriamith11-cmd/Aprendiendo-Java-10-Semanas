...
public class Main {
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(opcion){
                case 1: agregarEstudiante(sc, gestor);
                break;
                case 2: buscarEstudiante(sc, gestor);
                break;
                case 3: actualizarPromedio(sc, gestor);
                break;
                case 4: eliminarEstudiante(sc, gestor);
                break;
                case 5: gestor.mostrarRanking();
                break;
                case 6: gestor.mostrarTop5();
                break;
                case 7: System.out.println("Carrera: ");
                gestor.filtrarPorCarrera(sc.nextLine());
                break;
                case 8: gestor.mostrarEstadisticas();
                break;
                case 9: gestor.mostrarHistorial();
                break;
                case 0: System.out.println("Hazta Luego. ");
                break;
    ...
    private static void agregarEstudiante(Scanner sc, GestorEstudiante g){
    ...
    private static void buscarEstudiante(Scanner sc, GestorEstudiante g){
    ...
    private static void actualizarPromedio(Scanner sc, GestorEstudiante g){
    ...
    private static void eliminarEstudiante(Scanner sc, GestorEstudiante g){
    ...
    private static void cargarDatosPrueba(GestorEstudiante g){
        ...
        g.agregar(new Estudiante("2021010", "Diego Arce", "Civil", 67.0));
    }
}
